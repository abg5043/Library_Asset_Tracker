...
public class Library {
    ...
    //Password needed for changing the books in the library
    final static String PASSWORD = "TEST";

    /** The following method contains the main menu features of the class. It also contains the current library books.
     *
     * @input the user interacts with the menu through standard input. Users can only enter integers.
     *
     */
    ...
    public static void main(String[] args) {
	    ...
	    while (notDone) {
            ...
            System.out.println("  5) Add a Book (only if you have the password)");
            System.out.println("  6) Quit\n");

            var menuChoice = enterOnlyNumInRange("Please make a selection: ", 1, 6);
            ...
            switch(menuChoice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    renters = addAnEntry(renters);
                    loanedBooks = addAnEntry(loanedBooks);
                    dueDates = addAnEntry(dueDates);
                    books = addABook(books);
                    break;
                case 6:
    ...
    /** The following method adds a null entry to a given array, but keeps all current entries at their current indexes
     *
     * @param array = any array
     * @return = a copied array of array.length + 1;
     */


    public static String[] addAnEntry(String[] array) {
    ...
    /** The following method adds a book to the library's collection if the user has the password
     *
     * @param books = an array of all books the library owns
     * @input the user enters the new book through standard input.
     * @return = the book array either modified or not depending on if user had password
     */

    public static String[] addABook(String[] books) {
        var in = new Scanner(System.in);
        //check to see if user has the correct password or not
        if (askForPass()) {
            System.out.println("\nThanks for the correct password!\nPlease enter the new book: ");
            String newBook = in.nextLine();

            //add an entry to the book array
            books = addAnEntry(books);
            ...
            System.out.println("\nSorry! You ran out of attempts. Taking you back to the main menu.\n");
            return books;
        }
    }

    /** The following method prompts the user for the password and gives them 3 attempts.
     *
     * @input the user enters the password through standard input.
     * @return = boolean true or false
     */

    public static boolean askForPass() {
        var in = new Scanner(System.in);
        int attempts = 3;
        String password = "";
    ...
    public static void returnABook(String[] loanedBooks, String[] renters, String[] books, String[] dueDates) {
        ...
        String rentedBook = enterOnlyGivenStr("What book will be rented: ", loanedBooks, "Rented book not found. Please Try Again");
    ...
    public static void rentBook(String[] loanedBooks, String[] renters, String[] books, String[] dueDates) {
        ...
        String rentedBook = enterOnlyGivenStr("What book will be rented: ", books, "Unknown Book, Please Try Again");
        int i = 0;
        ...
        //check if book is already rented
            if (rentedBook.equalsIgnoreCase(loanedBooks[i])) {
                System.out.println("");
                var finished = enterOnlyGivenStr("Sorry, that book is rented until " + dueDates[i] + ".\nWould you like to try again? (y/n) ",
                ...
                if (finished.equalsIgnoreCase("n")) {
                    ...
                    System.out.println("");
                    rentedBook = enterOnlyGivenStr("What book will be rented: ", books, "Unknown Book, Please Try Again");
                    i = 0;
                }
            }
            i++;
    ...
    public static String enterOnlyGivenStr(String message, String[] options, String error) {
        var in = new Scanner(System.in);
    ...
    public static void backToMenu() {
        System.out.println("");
        var finished = enterOnlyGivenStr("Would you like to go back to the menu? (y/n) ", new String[] {"y", "n"},
